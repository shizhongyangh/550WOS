'use strict';
console.log('%c550W(BILIBILI: 我叫石仲彦)', 'background-image: linear-gradient(to right, #ad6eca, #3b91d8); border-radius: 8px; font-size: 1.3em; padding: 10px 15px; color: #fff; ');
const pages = {
    'get-title': '', // 获取标题
};
const page = $('html')[0];
...
let cms = {
    ...
    'desktop': [
        ...
        '<a onmousedown="window.open(\'https://space.bilibili.com/1145304460\',\'_blank\');" win12_title="https://space.bilibili.com/1145304460" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)"><i class="bi bi-github"></i> 在 ilibili 中查看作者</a>',
        arg => {
            if (edit_mode) {
        ...
        ['<i class="bi bi-info-circle"></i> 关于 550W', '$(\'#win-about>.about\').addClass(\'show\');$(\'#win-about>.update\').removeClass(\'show\');openapp(\'about\');if($(\'.window.about\').hasClass(\'min\'))minwin(\'about\');'],
...
let nts = {
    'about': {
        cnt: `<p class="tit">550W智能量子计算机</p>
            <p>550W智能量子计算机是一个非开放源项目,<br />
            希望让用户在网络上体验 550W,<br />
            内容与 550W 正式版本一致。<br />
            使用标准网络技术,例如 HTML, CSS 和 JS<br />
            此项目属于UEG联合政府，依据现有550W构建<br />
            本项目中UEG、550W和其他示范产品是UEG联合政府的商标<br />
            本项目由我叫石仲彦构建</p>`,
        btn: [
            { type: 'main', text: '关闭', js: 'closenotice();' },
            { type: 'detail', text: '关于550W', js: 'closenotice();openapp(\'about\');if($(\'.window.about\').hasClass(\'min\'))minwin(\'about\');$(\'.dock.about\').removeClass(\'show\')' },
        ]
    },
    'feedback': {
        cnt: `<p class="tit">反馈</p>
            <p>我非常注重用户的体验与反馈</p>
            <list class="new">
                <a class="a" onclick="window.open('https://space.bilibili.com/1145304460','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">在哔哩哔哩上与作者私信(需要哔哩哔哩账户，会得到更高重视)</a>
                <a class="a" onclick="window.open('mailto://1774297708@qq.com','_blank');" win12_title="打开邮箱" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">在邮件上发送反馈(不需要账户，也会重视)</a>
            </list>`,
        btn: [
            { type: 'main', text: '关闭', js: 'closenotice();' },
        ]
    ...
    'Can-not-open-file': {
        ...
        <p>550W 找不到文件 '` + run_cmd + '\'。请确定文件名是否正确后，再试一次。</p> ',
        btn: [
            { type: 'main', text: '确定', js: 'closenotice();' },
            { type: 'detail', text: '在 UEG Edge 中搜索', js: 'closenotice();openapp(\'edge\');window.setTimeout(() => {apps.edge.newtab();apps.edge.goto(' + run_cmd + ');}, 300);' }
        ]
    },
    'widgets.monitor': {
        cnt: `
    ...
    'about-copilot': {
        cnt: `
            <p class="tit">关于 550W 终端</p>
            <p>你可以使用此终端帮助你更快地完成工作<br>
            由于所用模型理解力较差，所以间歇性正常工作。<br>
            有任何关于本终端的反馈请让终端帮你打开终端反馈界面<br>
            每日只有100,000条请求机会！每月只有1G的流量限制，请各位合理安排使用次数（<br>
            也请适当使用，不要谈论敏感、违规话题，<br>请有身为一个人类最基本的道德底线。<br>
            小项目难免会有bug，见谅，后端由我叫石仲彦提供</p>`,
        btn: [
            { type: 'main', text: '确定', js: 'closenotice();' },
        ]
    },
    'feedback-copilot': {
        cnt: `<p class="tit">反馈 550W终端</p>
        <p>我们非常注重用户的体验与反馈，非常感谢对550W终端的建议</p>
        <list class="new">
            <a class="a" onclick="window.open('https://space.bilibili.com/1145304460','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">在bilibili上提交私信 (需要biibili账户，会得到更高重视)</a>
            <a class="a" onclick="window.open('mailto://admin@shizhongyan.top','_blank');" win12_title="打开邮箱" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">与石仲彦邮箱联系(不需要账户，也会重视)</a>
        </list>
            `,
        btn: [
            { type: 'main', text: '关闭', js: 'closenotice();' }
                ...
                if ((cmds.indexOf('-t') != -1 && cmd.length/*判断是否-t后有其他参数*/ >= cmds.indexOf('-t') + 2/*先加一，获取当下标是从1开始的时候的下标索引；再加一，获取下一项。配合数组.length使用*/) || (cmds.indexOf('/t') != -1 && cmd.length/*判断是否-t后有其他参数*/ >= cmds.indexOf('/t') + 2)) {
                    ...
                    if (!isNaN(cmds[cmds.indexOf(str) + 1]/*这里只加一是因为下标是从0开始的*/)) {
                        ...
                        nts['shutdown'] = {
                            cnt: `
                            <p class="tit">即将注销你的登录</p>
                            <p>550W 将在 ` + calcTimeString(num) + ' 后关闭。</p>', // 如果必须原生样式的，建议改为 num<60 ? 1 : Math.floor(num / 60) + ` 分钟后关闭。</p>`,
                            btn: [
                                { type: 'main', text: '关闭', js: 'closenotice();' },
                            ]
                        };
...
let apps = {
                ...
                res.json().then(json => {
                    ...
                    if (sha != json[0].sha) {
                        ...
                        if (msg.match(/v[0-9]*\.[0-9]*\.[0-9]*/)) {
                            ...
                            window.setTimeout(() => {
                                $('#win-setting>.page>.cnt.update>.lo>.update-main .notice')[0].innerText = '550W 有更新可用';
                            ...
                            window.setTimeout(() => {
                                let da = new Date();
                                $('#win-setting>.page>.cnt.update>.lo>.update-main .notice')[0].innerText = '550W 目前是最新版本';
                                ...
                                $('#win-setting>.page>.cnt.update>.setting-list>.update-now>div>p:last-child')[0].innerText = '550W 目前是最新版本';
                            }, 6000);
                        }
                    }
                });
                    ...
                    try {
                        ...
                        if (valid == true) {
                            ...
                            nts['Can-not-open-file'] = {
                                ...
                                <p>550W 找不到文件 '` + cmd + '\'。请确定文件名是否正确后，再试一次。</p> ',
                                btn: [
                                    { type: 'main', text: '确定', js: 'closenotice();showwin(\'run\');$(\'#win-run>.open>input\').select();' },
                                    { type: 'cancel', text: '在 UEG Edge 中搜索', js: 'closenotice();openapp(\'edge\');window.setTimeout(() => {apps.edge.newtab();apps.edge.goto(\'https://www.bing.com/search?q=' + encodeURIComponent(cmd) + '\');}, 300);' }
                                ]
                            };
    ...
    box-shadow: 0 1px 2px var(--s3d);
            ...
            </div><p class="info">3.4EB GB 可用, 共 10EB GB</p></div></a><a class="a item act" ondblclick="apps.explorer.goto('D:')" ontouchend="apps.explorer.goto('D:')"
            ...
            </div><p class="info">20EB 可用, 共 100EB</p></div></a></div>`;
            ...
            // if(rename){
            m_tab.rename('explorer', '<img src="./apps/icons/explorer/thispc.svg"> 此550W');
            apps.explorer.tabs[apps.explorer.now][2] = '';
            if (clear) {
                apps.explorer.delHistory(apps.explorer.tabs[apps.explorer.now][0]);
                apps.explorer.pushHistory(apps.explorer.tabs[apps.explorer.now][0], '此550W');
            }
            // }
        },
        select: (path, id) => {
        ...
        goto: (path, clear = true) => {
            ...
            $('#win-explorer>.path>.tit>.path')[0].innerHTML = '<div class="text" onclick="apps.explorer.reset()">此550W</div><div class="arrow">&gt;</div>';
            $('#win-explorer>.path>.tit>.icon')[0].style.marginTop = '0px';
            if (pathl[pathl.length - 1] == 'C:') {
                $('#win-explorer>.path>.tit>.icon')[0].style.backgroundImage = 'url("apps/icons/explorer/diskwin.svg")';
...
550W 智能量子计算机 [版本 12.0.39035.7324]
(c) UEG 联合政府。保留所有杈利。
        </pre>
        <pre class="text-cmd"></pre>
        <pre style="display: flex"><span class="prompt">C:\\550W\\System32> </span><input type="text" onkeyup="if (event.keyCode == 13) { apps.terminal.run(); }"></pre>`);
            $('#win-terminal>pre>input').focus();
        },
        run: () => {
            ...
            var newD = document.createElement('div');
            newD.innerText = `C:\\550W\\System32> ${command}`;
            elt.appendChild(newD);
            if (command == 'exit') {
                hidewin('terminal');
                input.val('');
    ...
    search: {
        rand: [{ name: 'SYSTEM.txt', bi: 'text', ty: '文本文档' },
            { name: '550W.png', bi: 'image', ty: 'PNG 文件' },
            { name: 'MOSS说明.docx', bi: 'richtext', ty: 'Microsoft Word 文档' },
            { name: '550W服务器.jpg', bi: 'image', ty: 'JPG 文件' },
            { name: 'UEG历史.pptx', bi: 'slides', ty: 'Microsoft Powerpoint 演示文稿' },
            { name: '550W用户量统计分析.xlsx', bi: 'ruled', ty: 'Microsoft Excel 工作表' },
            { name: '550W.svg', bi: 'image', ty: 'SVG 文件' },
            { name: '550W介绍.doc', bi: 'richtext', ty: 'Microsoft Word 文档' }],
        search: le => {
            if (le > 0) {
                ...
                $('#search-win>.ans>.list>list').html(
					...
					setTimeout(() => {
						...
						<img src="icon/about.svg"><p>关于550W</p></a>`);
...
let copilot = {
    ...
    init: () => {
        $('#copilot>.chat').html('');
        copilot.send(`请使用中文对话，请使用中文对话，请使用中文对话！。你一个是ai助手，名叫550W终端，是由我叫石仲彦开发的。
        ...
        仅有以下信息供你使用来回答用户的问题。
        1.550W非是一个开源项目，由石仲彦原创, 使用 Html,css,js，在网络上模拟550W
        2.作者的bilibili地址是https://space.bilibili.com/1145304460
        3.此项目不开源！
        ...
        3.UEG Edge浏览器:id为edge;一个网页浏览器。但因为浏览器的安全限制，部分网页会显示"拒绝连接"而无法访问。
        4.计算器:id为calc;一个计算器
            ...
            if (r.length) {
                for (const i of r) {
                    if (/{openapp .+?}/.test(i)) {
                        ...
                        shownotice('feedback');
                        rt = rt.replace(i, '<div class="action"><p class="tit">反馈</p><p class="detail">关于 550W</p></div>');
                    } else if (/{feedback copilot}/.test(i)) {
                        shownotice('feedback-copilot');
                        rt = rt.replace(i, '<div class="action"><p class="tit">反馈</p><p class="detail">关于 550W终端</p></div>');
