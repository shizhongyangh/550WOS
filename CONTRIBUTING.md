...
2. 请尽量使用Git命令行、Github Desktop、[https://github.dev](https://github.dev/shizhongyangh/shizhongyan.github.io)等方式进行提交。请不要直接在浏览器中上传文件来提交。
...
### 提交信息要求
   ...
   1. 若更新具有一定重要性或量级时，请按照以下格式：
      ...
      - 注意：
         ...
         2. 在更新时，记住要在“关于 550W网页版”应用的更新记录中，添加关于该更新的相关内容。
